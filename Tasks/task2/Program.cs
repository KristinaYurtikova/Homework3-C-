...
Console.WriteLine("Введите через пробел координаты Х, У, Z точки А");
...
Console.WriteLine("Введите через пробел координаты Х, У, Z точки B");
...
Console.WriteLine($"Расстояние между точками А и В равно {distance} единиц");
